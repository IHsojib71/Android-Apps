...
public class Knee_push_ups extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.home_button:
                Intent intent = new Intent(Knee_push_ups.this,Dashboard.class);
                startActivity(intent);
                finish();
                break;

            case R.id.workout_dashboard:
                intent = new Intent(Knee_push_ups.this,Workout_dashboard.class);
                startActivity(intent);
                finish();
                break;
            case R.id.weekly_workout:
                intent = new Intent(Knee_push_ups.this,Full_Body_plans_week.class);
                startActivity(intent);
                finish();
                break;
            case R.id.nextButton:
                intent = new Intent(Knee_push_ups.this,Push_ups.class);
                startActivity(intent);
                finish();
                break;
            case R.id.backward_button:
                intent = new Intent(Knee_push_ups.this,Incline_push_ups.class);
                startActivity(intent);
                finish();
                break;
        }
