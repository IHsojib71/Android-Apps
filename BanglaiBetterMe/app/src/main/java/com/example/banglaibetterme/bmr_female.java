...
public class bmr_female extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmr_female);
    ...
    public void calculateBMR(View view) {
        ...
        float bmr = (float) ((10*weightValue)+(6.25*heightValue)-(5*ageValue)-161);

        float final_bmr=bmr*workout_value;
        calculation=""+bmr+"\n";
        ...
        FirebaseDatabase.getInstance().getReference("BMR")
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(bmr_female.this,"ডাটা সংরক্ষন হয়েছে!",Toast.LENGTH_SHORT).show();
            }
        });
